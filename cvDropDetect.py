# Author: Addison Sears-Collins modified by Michael G. Hale on 16/06/2023
...
# When Object is detected the event is registered in a csv file
# along with delta time.

# import the necessary packages
from picamera.array import PiRGBArray # Generates a 3D RGB array
from picamera import PiCamera # Provides a Python interface for the RPi Camera Module
from datetime import datetime, timedelta #for delta times
...
#menu
fileName=input('Please enter a file name NOT starting with a digit or special character?:\n')
